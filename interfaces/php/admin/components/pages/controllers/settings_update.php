...
if (isset($_POST['doupgrade'])) {
	$upgrade_file_contents = CASHSystem::getURLContents('https://raw.github.com/cashmusic/DIY/latest_stable/installers/php/update/update.php');
...
$current_profile_url = 'https://raw.github.com/cashmusic/DIY/latest_stable/installers/php/update/releaseprofiles/release_'
...
if (CASHSystem::getURLContents($current_profile_url)) {
	...
	$upgrade_script_url = 'https://raw.github.com/cashmusic/DIY/latest_stable/installers/php/update/updatescripts/'
						. $cash_admin->page_data['platform_version']
						. '.php';
