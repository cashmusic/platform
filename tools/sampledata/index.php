...
<html lang="en">
<head> 
<title>CASH Music / Sample Data</title>
...
<body>
	...
	<div id="mainspc" class="row">
		...
		<p>
			Clicking around aimlessly to fill up enough data to test with is boring. Use this to add a bunch of sample data to your platform install.
		</p>
