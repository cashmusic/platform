...
CREATE TABLE `assets_analytics` (
  ...
  `client_proxy` varchar(255) NOT NULL,
...
CREATE TABLE `commerce_transactions` (
  ...
  `parent` varchar(255) NOT NULL DEFAULT 'order',
...
DROP TABLE IF EXISTS `elements_campaigns`;
...
CREATE TABLE `system_metadata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `scope_table_alias` varchar(255) NOT NULL DEFAULT '',
