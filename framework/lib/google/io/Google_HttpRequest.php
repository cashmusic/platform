...
class Google_HttpRequest {
  ...
  public function __construct($url, $method = 'GET', $headers = array(), $postBody = null) {
    ...
    if (empty($GLOBALS['googleApiConfig']['application_name'])) {
      $this->userAgent = self::USER_AGENT_SUFFIX;
    } else {
      $this->userAgent = $GLOBALS['googleApiConfig']['application_name'] . " " . self::USER_AGENT_SUFFIX;
    }
  }
  ...
  public function setUrl($url) {
    if (substr($url, 0, 4) == 'http') {
      ...
      $this->url = $GLOBALS['googleApiConfig']['basePath'] . $url;
    }
  }
