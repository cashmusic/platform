...
// look for a config.php file, if found we support it and the local_config.php convention
if (file_exists(dirname(__FILE__)  . '/config.php')) {
  ...
  if (file_exists(dirname(__FILE__)  . '/local_config.php')) {
    ...
    $apiConfig = array_merge($googleConfig, $apiConfig);
  }
}
...
class Google_Client {
  ...
  // Store default config in the Class itself
  protected $googleConfig = array(
  ...
  public function __construct($config = array()) {
    ...
    if (!isset($this->googleConfig['ioFileCache_directory'])) {
      $this->googleConfig['ioFileCache_directory'] =
  ...
  public function addService($service, $version = false) {
    ...
    if (isset($this->googleConfig['services'][$service])) {
      // Merge the service descriptor with the default values
      $this->services[$service] = array_merge($this->services[$service], $this->googleConfig['services'][$service]);
    }
  }
  ...
  public function setApplicationName($applicationName) {
    $this->googleConfig['application_name'] = $applicationName;
  }
  ...
  public function setClientId($clientId) {
    $this->googleConfig['oauth2_client_id'] = $clientId;
  ...
  public function setClientSecret($clientSecret) {
    $this->googleConfig['oauth2_client_secret'] = $clientSecret;
  ...
  public function setRedirectUri($redirectUri) {
    $this->googleConfig['oauth2_redirect_uri'] = $redirectUri;
  ...
  public function setUseObjects($useObjects) {
    $this->googleConfig['use_objects'] = $useObjects;
  }
